...
public class MetaModelNativeField<T,V> extends MetaModelField<T,V> {
	
	private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

	public MetaModelNativeField(MetaModelClass<T> metaModelClass, Class<V> javaType, Member member) {
