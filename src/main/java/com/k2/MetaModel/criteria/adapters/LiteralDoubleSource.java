...
public class LiteralDoubleSource extends ItemAdapter {

	public LiteralDoubleSource() { super("DOUBLE"); }

	@Override
	public CriteriaExpression read(CriteriaTypeAdapter cta, JsonReader reader) throws IOException {
		return SourceCriteria.literal(reader.nextString(), Double.class);
	}
