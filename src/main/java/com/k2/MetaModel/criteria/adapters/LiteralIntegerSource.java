...
public class LiteralIntegerSource extends ItemAdapter {

	public LiteralIntegerSource() { super("INTEGER"); }

	@Override
	public CriteriaExpression read(CriteriaTypeAdapter cta, JsonReader reader) throws IOException {
		return SourceCriteria.literal(reader.nextString(), Integer.class);
	}
