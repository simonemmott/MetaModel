...
public class LiteralStringSource extends ItemAdapter {

	public LiteralStringSource() { super("STRING"); }

	@Override
	public CriteriaExpression read(CriteriaTypeAdapter cta, JsonReader reader) throws IOException {
		return SourceCriteria.literal(reader.nextString(), String.class);
	}
